...
func TestCreateSession_RestartFromSessionId_DerivesPathFromSource(t *testing.T) {
	...
	assert.Equal(t, sourcePath, resp.Msg.Session.ActiveDir, "path should be derived from the source session")
...
func TestCreateSession_RestartFromSessionId_ExplicitPathWins(t *testing.T) {
	...
	assert.Equal(t, explicitPath, resp.Msg.Session.ActiveDir, "explicit path must win over the restart-derived path")
...
func TestCreateSession_RestartFromSessionId_ProceedsWhenLiveSourceConfirmed(t *testing.T) {
	...
	assert.Equal(t, sourcePath, resp.Msg.Session.ActiveDir, "path should be derived from the confirmed live source")
