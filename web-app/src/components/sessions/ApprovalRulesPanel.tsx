...
export function ApprovalRulesPanel({ prefill }: ApprovalRulesPanelProps) {
  ...
  const [urlPrefill, setUrlPrefill] = useState<import("@/lib/ruleBuilderPrefill").RuleBuilderPrefill | null>(null);
  ...
  useEffect(() => {
    ...
    const fill: import("@/lib/ruleBuilderPrefill").RuleBuilderPrefill = {};
    if (tool) {
      fill.toolName = tool;
    } else if (program) {
      fill.toolName = "Bash";
