...
// TestAllStuckReasons_should_contain14Entries_When_Enumerated is a regression
...
func TestAllStuckReasons_should_contain14Entries_When_Enumerated(t *testing.T) {
	if len(AllStuckReasons) != 14 {
		t.Errorf("len(AllStuckReasons) = %d, want 14", len(AllStuckReasons))
	}
}
