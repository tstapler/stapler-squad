...
//nolint:gocognit // pre-existing complexity relocated verbatim by the tmux.go split (sdd:fix-hotspot, 2026-09-12); reducing it is a separate follow-up, not a file move
