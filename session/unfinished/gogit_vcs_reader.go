...
//
// Memory note: each cached *git.Repository holds an internal object LRU cache
// (~96 MB per repo by default). Call ClearCache() periodically (e.g. every
// 5 minutes) to release these caches and bound total memory usage.
