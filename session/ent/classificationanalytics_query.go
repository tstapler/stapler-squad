...
type ClassificationAnalyticsQuery struct {
	config
	ctx        *QueryContext
	order      []classificationanalytics.OrderOption
	inters     []Interceptor
...
// First returns the first ClassificationAnalytics entity from the query.
// Returns a *NotFoundError when no ClassificationAnalytics was found.
func (_q *ClassificationAnalyticsQuery) First(ctx context.Context) (*ClassificationAnalytics, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{classificationanalytics.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first ClassificationAnalytics ID from the query.
// Returns a *NotFoundError when no ClassificationAnalytics ID was found.
...
// Only returns a single ClassificationAnalytics entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one ClassificationAnalytics entity is found.
// Returns a *NotFoundError when no ClassificationAnalytics entities are found.
func (_q *ClassificationAnalyticsQuery) Only(ctx context.Context) (*ClassificationAnalytics, error) {
	...
	case 0:
		return nil, &NotFoundError{classificationanalytics.Label}
	default:
		return nil, &NotSingularError{classificationanalytics.Label}
	}
}
...
// OnlyID is like Only, but returns the only ClassificationAnalytics ID in the query.
// Returns a *NotSingularError when more than one ClassificationAnalytics ID is found.
...
func (_q *ClassificationAnalyticsQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{classificationanalytics.Label}
	default:
		err = &NotSingularError{classificationanalytics.Label}
	}
	return
}
...
func (_q *ClassificationAnalyticsQuery) All(ctx context.Context) ([]*ClassificationAnalytics, error) {
	...
	qr := querierAll[[]*ClassificationAnalytics, *ClassificationAnalyticsQuery]()
	return withInterceptors[[]*ClassificationAnalytics](ctx, _q, qr, _q.inters)
}
...
func (_q *ClassificationAnalyticsQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(classificationanalytics.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ClassificationAnalyticsQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*ClassificationAnalyticsQuery](), _q.inters)
}
...
// Clone returns a duplicate of the ClassificationAnalyticsQuery builder, including all associated steps. It can be
...
func (_q *ClassificationAnalyticsQuery) Clone() *ClassificationAnalyticsQuery {
	...
	return &ClassificationAnalyticsQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]classificationanalytics.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.ClassificationAnalytics{}, _q.predicates...),
...
func (_q *ClassificationAnalyticsQuery) GroupBy(field string, fields ...string) *ClassificationAnalyticsGroupBy {
	...
	grbuild := &ClassificationAnalyticsGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = classificationanalytics.Label
...
func (_q *ClassificationAnalyticsQuery) Select(fields ...string) *ClassificationAnalyticsSelect {
	...
	sbuild := &ClassificationAnalyticsSelect{ClassificationAnalyticsQuery: _q}
	sbuild.label = classificationanalytics.Label
...
func (_q *ClassificationAnalyticsQuery) prepareQuery(ctx context.Context) error {
...
func (_q *ClassificationAnalyticsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ClassificationAnalytics, error) {
	var (
		nodes = []*ClassificationAnalytics{}
		_spec = _q.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*ClassificationAnalytics).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &ClassificationAnalytics{config: _q.config}
...
func (_q *ClassificationAnalyticsQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *ClassificationAnalyticsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(classificationanalytics.Table, classificationanalytics.Columns, sqlgraph.NewFieldSpec(classificationanalytics.FieldID, field.TypeInt))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != classificationanalytics.FieldID {
...
func (_q *ClassificationAnalyticsQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(classificationanalytics.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = classificationanalytics.Columns
	}
...
type ClassificationAnalyticsGroupBy struct {
	selector
	build *ClassificationAnalyticsQuery
}
...
func (_g *ClassificationAnalyticsGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ClassificationAnalyticsQuery, *ClassificationAnalyticsGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *ClassificationAnalyticsGroupBy) sqlScan(ctx context.Context, root *ClassificationAnalyticsQuery, v any) error {
...
func (_s *ClassificationAnalyticsSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ClassificationAnalyticsQuery, *ClassificationAnalyticsSelect](ctx, _s.ClassificationAnalyticsQuery, _s, _s.inters, v)
}

func (_s *ClassificationAnalyticsSelect) sqlScan(ctx context.Context, root *ClassificationAnalyticsQuery, v any) error {
