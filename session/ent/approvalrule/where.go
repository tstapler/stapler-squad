...
// SafePythonImportsOnlyIsNil applies the IsNil predicate on the "safe_python_imports_only" field.
func SafePythonImportsOnlyIsNil() predicate.ApprovalRule {
	return predicate.ApprovalRule(sql.FieldIsNull(FieldSafePythonImportsOnly))
}

// SafePythonImportsOnlyNotNil applies the NotNil predicate on the "safe_python_imports_only" field.
func SafePythonImportsOnlyNotNil() predicate.ApprovalRule {
	return predicate.ApprovalRule(sql.FieldNotNull(FieldSafePythonImportsOnly))
}
