...
func (_d *ClassificationAnalyticsDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(classificationanalytics.Table, sqlgraph.NewFieldSpec(classificationanalytics.FieldID, field.TypeInt))
...
type ClassificationAnalyticsDeleteOne struct {
	_d *ClassificationAnalyticsDelete
}
...
func (_d *ClassificationAnalyticsDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{classificationanalytics.Label}
	default:
		return nil
	}
}
