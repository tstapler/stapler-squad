...
func init() {
	...
	backlogitemDescPrNumber := backlogitemFields[27].Descriptor()
	...
	backlogitemDescShippedApprovedCount := backlogitemFields[29].Descriptor()
	...
	backlogitemDescShippedChangesReqCount := backlogitemFields[30].Descriptor()
	...
	backlogitemDescShippedSnapshotCaptureFailed := backlogitemFields[33].Descriptor()
	...
	backlogitemDescCreatedAt := backlogitemFields[35].Descriptor()
	...
	backlogitemDescUpdatedAt := backlogitemFields[36].Descriptor()
