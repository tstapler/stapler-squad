...
const file_session_v1_backlog_proto_rawDesc = "" +
	...
	"\tcancelled\x18\x01 \x01(\bR\tcancelled2\x80\x10\n" +
...
var file_session_v1_backlog_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_session_v1_backlog_proto_goTypes = []any{
	...
	(*CancelTriageRequest)(nil),                 // 51: session.v1.CancelTriageRequest
	(*CancelTriageResponse)(nil),                // 52: session.v1.CancelTriageResponse
...
var file_session_v1_backlog_proto_depIdxs = []int32{
	...
	53, // 1: session.v1.ReviewVerdict.override_at:type_name -> google.protobuf.Timestamp
	53, // 2: session.v1.ReviewVerdict.created_at:type_name -> google.protobuf.Timestamp
	...
	53, // 5: session.v1.ItemSession.started_at:type_name -> google.protobuf.Timestamp
	53, // 6: session.v1.ItemSession.ended_at:type_name -> google.protobuf.Timestamp
	53, // 7: session.v1.ItemSession.last_commit_at:type_name -> google.protobuf.Timestamp
	53, // 8: session.v1.ItemSession.last_file_touch_at:type_name -> google.protobuf.Timestamp
	53, // 9: session.v1.ItemSession.created_at:type_name -> google.protobuf.Timestamp
	...
	53, // 12: session.v1.BacklogStatusEvent.created_at:type_name -> google.protobuf.Timestamp
	0,  // 13: session.v1.BacklogItem.acceptance_criteria:type_name -> session.v1.AcCriterion
	53, // 14: session.v1.BacklogItem.plan_approved_at:type_name -> google.protobuf.Timestamp
	53, // 15: session.v1.BacklogItem.archived_at:type_name -> google.protobuf.Timestamp
	53, // 16: session.v1.BacklogItem.created_at:type_name -> google.protobuf.Timestamp
	53, // 17: session.v1.BacklogItem.updated_at:type_name -> google.protobuf.Timestamp
	...
	53, // 20: session.v1.ItemSource.last_synced_at:type_name -> google.protobuf.Timestamp
	53, // 21: session.v1.ItemSource.created_at:type_name -> google.protobuf.Timestamp
	53, // 22: session.v1.ItemSource.updated_at:type_name -> google.protobuf.Timestamp
	53, // 23: session.v1.SourceSyncEvent.started_at:type_name -> google.protobuf.Timestamp
	53, // 24: session.v1.SourceSyncEvent.finished_at:type_name -> google.protobuf.Timestamp
	...
	53, // 30: session.v1.UpdateBacklogItemRequest.expected_updated_at:type_name -> google.protobuf.Timestamp
	...
	53, // 33: session.v1.TransitionBacklogItemStatusRequest.expected_updated_at:type_name -> google.protobuf.Timestamp
	...
	21, // 52: session.v1.BacklogService.DeleteBacklogItem:input_type -> session.v1.DeleteBacklogItemRequest
	23, // 53: session.v1.BacklogService.TransitionBacklogItemStatus:input_type -> session.v1.TransitionBacklogItemStatusRequest
	25, // 54: session.v1.BacklogService.SpawnSessionFromItem:input_type -> session.v1.SpawnSessionFromItemRequest
	27, // 55: session.v1.BacklogService.AttachSessionToItem:input_type -> session.v1.AttachSessionToItemRequest
	29, // 56: session.v1.BacklogService.TriggerTriage:input_type -> session.v1.TriggerTriageRequest
	51, // 57: session.v1.BacklogService.CancelTriage:input_type -> session.v1.CancelTriageRequest
	31, // 58: session.v1.BacklogService.ApprovePlan:input_type -> session.v1.ApprovePlanRequest
	33, // 59: session.v1.BacklogService.SuggestNextItem:input_type -> session.v1.SuggestNextItemRequest
	35, // 60: session.v1.BacklogService.OverrideVerdict:input_type -> session.v1.OverrideVerdictRequest
	37, // 61: session.v1.BacklogService.TriggerReReview:input_type -> session.v1.TriggerReReviewRequest
	39, // 62: session.v1.BacklogService.TriggerSync:input_type -> session.v1.TriggerSyncRequest
	41, // 63: session.v1.BacklogService.CreateItemSource:input_type -> session.v1.CreateItemSourceRequest
	43, // 64: session.v1.BacklogService.ListItemSources:input_type -> session.v1.ListItemSourcesRequest
	45, // 65: session.v1.BacklogService.UpdateItemSource:input_type -> session.v1.UpdateItemSourceRequest
	47, // 66: session.v1.BacklogService.DeleteItemSource:input_type -> session.v1.DeleteItemSourceRequest
	49, // 67: session.v1.BacklogService.GetSyncHistory:input_type -> session.v1.GetSyncHistoryRequest
	12, // 68: session.v1.BacklogService.CreateBacklogItem:output_type -> session.v1.CreateBacklogItemResponse
	14, // 69: session.v1.BacklogService.GetBacklogItem:output_type -> session.v1.GetBacklogItemResponse
	16, // 70: session.v1.BacklogService.ListBacklogItems:output_type -> session.v1.ListBacklogItemsResponse
	18, // 71: session.v1.BacklogService.UpdateBacklogItem:output_type -> session.v1.UpdateBacklogItemResponse
	20, // 72: session.v1.BacklogService.ArchiveBacklogItem:output_type -> session.v1.ArchiveBacklogItemResponse
	22, // 73: session.v1.BacklogService.DeleteBacklogItem:output_type -> session.v1.DeleteBacklogItemResponse
	24, // 74: session.v1.BacklogService.TransitionBacklogItemStatus:output_type -> session.v1.TransitionBacklogItemStatusResponse
	26, // 75: session.v1.BacklogService.SpawnSessionFromItem:output_type -> session.v1.SpawnSessionFromItemResponse
	28, // 76: session.v1.BacklogService.AttachSessionToItem:output_type -> session.v1.AttachSessionToItemResponse
	30, // 77: session.v1.BacklogService.TriggerTriage:output_type -> session.v1.TriggerTriageResponse
	52, // 78: session.v1.BacklogService.CancelTriage:output_type -> session.v1.CancelTriageResponse
	32, // 79: session.v1.BacklogService.ApprovePlan:output_type -> session.v1.ApprovePlanResponse
	34, // 80: session.v1.BacklogService.SuggestNextItem:output_type -> session.v1.SuggestNextItemResponse
	36, // 81: session.v1.BacklogService.OverrideVerdict:output_type -> session.v1.OverrideVerdictResponse
	38, // 82: session.v1.BacklogService.TriggerReReview:output_type -> session.v1.TriggerReReviewResponse
	40, // 83: session.v1.BacklogService.TriggerSync:output_type -> session.v1.TriggerSyncResponse
	42, // 84: session.v1.BacklogService.CreateItemSource:output_type -> session.v1.CreateItemSourceResponse
	44, // 85: session.v1.BacklogService.ListItemSources:output_type -> session.v1.ListItemSourcesResponse
	46, // 86: session.v1.BacklogService.UpdateItemSource:output_type -> session.v1.UpdateItemSourceResponse
	48, // 87: session.v1.BacklogService.DeleteItemSource:output_type -> session.v1.DeleteItemSourceResponse
	50, // 88: session.v1.BacklogService.GetSyncHistory:output_type -> session.v1.GetSyncHistoryResponse
