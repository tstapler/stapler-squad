...
const (
	...
	StuckReason_STUCK_REASON_LIKELY_FLAKY StuckReason = 15
)
...
type BacklogItem struct {
	...
	PlanRejectionReason string                 `protobuf:"bytes,33,opt,name=plan_rejection_reason,json=planRejectionReason,proto3" json:"plan_rejection_reason,omitempty"`
	PlanRejectedAt      *timestamppb.Timestamp `protobuf:"bytes,34,opt,name=plan_rejected_at,json=planRejectedAt,proto3" json:"plan_rejected_at,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_session_v1_backlog_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xa0\f\n" +
	...
	"\x13allowed_transitions\x18  \x03(\tR\x12allowedTransitions\x122\n" +
	"\x15plan_rejection_reason\x18! \x01(\tR\x13planRejectionReason\x12D\n" +
	"\x10plan_rejected_at\x18\" \x01(\v2\x1a.google.protobuf.TimestampR\x0eplanRejectedAtB\x10\n" +
	...
	"\x04item\x18\x01 \x01(\v2\x17.session.v1.BacklogItemR\x04item\"D\n" +
	...
	"\x19STUCK_REASON_LIKELY_FLAKY\x10\x0f2\xeb!\n" +
	...
	"\n" +
	"RejectPlan\x12\x1d.session.v1.RejectPlanRequest\x1a\x1e.session.v1.RejectPlanResponse\"\x00\x12\\\n" +
...
var file_session_v1_backlog_proto_goTypes = []any{
	...
	(*SuggestNextItemRequest)(nil),              // 43: session.v1.SuggestNextItemRequest
	(*SuggestNextItemResponse)(nil),             // 44: session.v1.SuggestNextItemResponse
	(*OverrideVerdictRequest)(nil),              // 45: session.v1.OverrideVerdictRequest
	(*OverrideVerdictResponse)(nil),             // 46: session.v1.OverrideVerdictResponse
	(*TriggerReReviewRequest)(nil),              // 47: session.v1.TriggerReReviewRequest
	(*TriggerReReviewResponse)(nil),             // 48: session.v1.TriggerReReviewResponse
	(*TriggerShipPRRequest)(nil),                // 49: session.v1.TriggerShipPRRequest
	(*TriggerShipPRResponse)(nil),               // 50: session.v1.TriggerShipPRResponse
	(*TriggerSyncRequest)(nil),                  // 51: session.v1.TriggerSyncRequest
	(*TriggerSyncResponse)(nil),                 // 52: session.v1.TriggerSyncResponse
	(*CreateItemSourceRequest)(nil),             // 53: session.v1.CreateItemSourceRequest
	(*CreateItemSourceResponse)(nil),            // 54: session.v1.CreateItemSourceResponse
	(*ListItemSourcesRequest)(nil),              // 55: session.v1.ListItemSourcesRequest
	(*ListItemSourcesResponse)(nil),             // 56: session.v1.ListItemSourcesResponse
	(*UpdateItemSourceRequest)(nil),             // 57: session.v1.UpdateItemSourceRequest
	(*UpdateItemSourceResponse)(nil),            // 58: session.v1.UpdateItemSourceResponse
	(*DeleteItemSourceRequest)(nil),             // 59: session.v1.DeleteItemSourceRequest
	(*DeleteItemSourceResponse)(nil),            // 60: session.v1.DeleteItemSourceResponse
	(*GetSyncHistoryRequest)(nil),               // 61: session.v1.GetSyncHistoryRequest
	(*GetSyncHistoryResponse)(nil),              // 62: session.v1.GetSyncHistoryResponse
	(*PreviewBackwardSyncImpactRequest)(nil),    // 63: session.v1.PreviewBackwardSyncImpactRequest
	(*PreviewBackwardSyncImpactResponse)(nil),   // 64: session.v1.PreviewBackwardSyncImpactResponse
...
var file_session_v1_backlog_proto_depIdxs = []int32{
	...
	43,  // 112: session.v1.BacklogService.SuggestNextItem:input_type -> session.v1.SuggestNextItemRequest
	45,  // 113: session.v1.BacklogService.OverrideVerdict:input_type -> session.v1.OverrideVerdictRequest
	47,  // 114: session.v1.BacklogService.TriggerReReview:input_type -> session.v1.TriggerReReviewRequest
	49,  // 115: session.v1.BacklogService.TriggerShipPR:input_type -> session.v1.TriggerShipPRRequest
	51,  // 116: session.v1.BacklogService.TriggerSync:input_type -> session.v1.TriggerSyncRequest
	53,  // 117: session.v1.BacklogService.CreateItemSource:input_type -> session.v1.CreateItemSourceRequest
	55,  // 118: session.v1.BacklogService.ListItemSources:input_type -> session.v1.ListItemSourcesRequest
	57,  // 119: session.v1.BacklogService.UpdateItemSource:input_type -> session.v1.UpdateItemSourceRequest
	59,  // 120: session.v1.BacklogService.DeleteItemSource:input_type -> session.v1.DeleteItemSourceRequest
	61,  // 121: session.v1.BacklogService.GetSyncHistory:input_type -> session.v1.GetSyncHistoryRequest
	63,  // 122: session.v1.BacklogService.PreviewBackwardSyncImpact:input_type -> session.v1.PreviewBackwardSyncImpactRequest
	...
	44,  // 155: session.v1.BacklogService.SuggestNextItem:output_type -> session.v1.SuggestNextItemResponse
	46,  // 156: session.v1.BacklogService.OverrideVerdict:output_type -> session.v1.OverrideVerdictResponse
	48,  // 157: session.v1.BacklogService.TriggerReReview:output_type -> session.v1.TriggerReReviewResponse
	50,  // 158: session.v1.BacklogService.TriggerShipPR:output_type -> session.v1.TriggerShipPRResponse
	52,  // 159: session.v1.BacklogService.TriggerSync:output_type -> session.v1.TriggerSyncResponse
	54,  // 160: session.v1.BacklogService.CreateItemSource:output_type -> session.v1.CreateItemSourceResponse
	56,  // 161: session.v1.BacklogService.ListItemSources:output_type -> session.v1.ListItemSourcesResponse
	58,  // 162: session.v1.BacklogService.UpdateItemSource:output_type -> session.v1.UpdateItemSourceResponse
	60,  // 163: session.v1.BacklogService.DeleteItemSource:output_type -> session.v1.DeleteItemSourceResponse
	62,  // 164: session.v1.BacklogService.GetSyncHistory:output_type -> session.v1.GetSyncHistoryResponse
	64,  // 165: session.v1.BacklogService.PreviewBackwardSyncImpact:output_type -> session.v1.PreviewBackwardSyncImpactResponse
