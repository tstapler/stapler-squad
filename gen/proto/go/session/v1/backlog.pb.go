...
const (
	...
	StuckReason_STUCK_REASON_MULTIPLE_REASONS StuckReason = 15
	...
	StuckReason_STUCK_REASON_BOUNCE_CAP_EXHAUSTED StuckReason = 16
)
...
var (
	StuckReason_name = map[int32]string{
		...
		15: "STUCK_REASON_MULTIPLE_REASONS",
		16: "STUCK_REASON_BOUNCE_CAP_EXHAUSTED",
	}
	StuckReason_value = map[string]int32{
		...
		"STUCK_REASON_MULTIPLE_REASONS":       15,
		"STUCK_REASON_BOUNCE_CAP_EXHAUSTED":   16,
	}
)
...
const file_session_v1_backlog_proto_rawDesc = "" +
	...
	"\ttriggered\x18\x01 \x01(\bR\ttriggered*\xc9\x04\n" +
	...
	"#STUCK_REASON_RESPAWN_BLOCKED_ACTIVE\x10\x0e\x12!\n" +
	"\x1dSTUCK_REASON_MULTIPLE_REASONS\x10\x0f\x12%\n" +
	"!STUCK_REASON_BOUNCE_CAP_EXHAUSTED\x10\x102\x9c!\n" +
