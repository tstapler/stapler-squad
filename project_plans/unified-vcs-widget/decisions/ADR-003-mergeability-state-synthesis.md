# ADR-003: Client-Side `MergeabilityState` Synthesis Fixes the Closed/Merged Conflation Bug

**Status**: Accepted
**Date**: 2026-07-18
**Project**: unified-vcs-widget

**Promoted to `docs/adr/ADR-026-mergeability-state-synthesis.md`.** Note: `plan.md`'s Story 1.1.5 amends this decision with a 10th state (`"snapshot_unavailable"`) per an architecture-review BLOCKER fix — see the promoted copy's header note.
