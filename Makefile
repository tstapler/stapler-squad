...
lint-custom: $(LINTER_BIN) ## Run project-specific custom linters (entfullscan, hotpolllog, nocommandpattern, norawexec, silenttransition, tmuxsocketscope) in a single pass
